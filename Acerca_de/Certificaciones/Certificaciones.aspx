<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Certificaciones.aspx.cs" Inherits="_Default" %>
    ...
    <div class="container" style="margin-bottom:-15px;">
        <div class="container" id="title">
            <div class="contenedor justify-content-center justify-content-md-between">
                <h3 class="texto-encima centrado" style="width:100%; letter-spacing:1px;">Certificaciones</h3>
            </div>
        </div>
    </div>
    <br />
            ...
            <div class="row">
                ...
                <div class="col-lg-2 content order-1 order-lg-1">
                    <ul class="text-end pags lisnrg">
                        <a href="/Posgrado/Acerca_de/Certificaciones/Certificaciones/Certificaciones.aspx">
                            <li class="logo px-2 pb-0 bg-light" style="color: black !important; border-bottom-style: dashed; border-width: 1px;"><b>Certificaciones</b></li>
                        </a>       
                        <%--<a href="/Posgrado/EdContinua_Inicio.aspx">
                            <li class="logo px-2 pb-0" style="border-bottom-style: dashed; border-width: 1px;">Certificaci&oacute;n 2</li>
                        </a>
                        <a href="/Posgrado/EdContinua_Inicio.aspx">
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                    <%--<div class="menu lisnrg">
                        ...
                        <ul>
                            ...
                            <a href="#">
                                <li class="border ps-2">Certificaci&oacute;n 1</li>
                            </a>
                            <a href="#">
                                <li class="border ps-2">Certificaci&oacute;n 2</li>
                            </a>
                            <a href="#">
                                <li class="border ps-2">Certificaci&oacute;n 3</li>
                            </a>
                            <a href="#">
                                <li class="border ps-2">...</li>
                            </a>
                            <a href="#">
                                <li class="border ps-2">Certificaci&oacute;n n</li>
                            </a>
