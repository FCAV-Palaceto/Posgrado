<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Filosofia_Vision.aspx.cs" Inherits="_Default" %>
    ...
    <div class="container" style="margin-bottom:-15px;">
        <div class="container" id="title">
            <div class="contenedor justify-content-center justify-content-md-between">
                <h3 class="texto-encima centrado" style="letter-spacing:1px; width:100%;">Visi&oacute;n</h3>
            </div>
        </div>
    </div>
    <br />
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                    <div class="menu lisnrg">
                        ...
                        <ul>                            
                            ...
                            <a href="/Posgrado/Acerca_de/Filosofia/Filosofia_Vision.aspx">
                                <li class="border ps-2 bg-light"><b>Visi&oacute;n</b></li>
                            </a>                                                       
                        </ul>
                    </div>
