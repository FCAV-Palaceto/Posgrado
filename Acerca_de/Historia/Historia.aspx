<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Historia.aspx.cs" Inherits="_Default" %>
    ...
    <div class="container" style="margin-bottom:-15px;">
        <div class="container" id="title">
            <div class="contenedor justify-content-center justify-content-md-between">
                <h3 class="texto-encima centrado" style="letter-spacing:1px; width:100%;">Historia</h3>
            </div>
        </div>
    </div>
    <br />
            ...
            <div class="row">
                ...
                <div class="col-lg-2 content order-1 order-lg-1">
                    <ul class="text-end pags lisnrg">
                        <a href="/Posgrado/Acerca_de/Historia/Historia/Historia.aspx">
                            <li class="logo px-2 pb-0 bg-light" style="color: black !important; border-bottom-style: dashed; border-width: 1px;"><b>Historia</b></li>
                        </a>                            
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                   <%-- <div class="menu lisnrg">
                        ...
                        <ul>
                            ...
                            <a href="/Posgrado/Filosofia_Mision.aspx">
                                <li class="border ps-2">Misi&oacute;n</li>
                            </a>
