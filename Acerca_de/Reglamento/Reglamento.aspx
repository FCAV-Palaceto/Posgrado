<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Reglamento.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <%--<div class="container" style="margin-bottom:-15px;">
        <img src="<%= Page.ResolveUrl("~")%>assets/img/Separador.png" alt="separador" style="width: 100%;">
    </div>--%>    
    <div class="container" style="margin-bottom:-15px;">
        <div class="container" id="title">
            <div class="contenedor justify-content-center justify-content-md-between">
                <h3 class="texto-encima centrado" style="width:100%; letter-spacing:1px;">Reglamento</h3>
            </div>
        </div>
    </div>
    <br />
            ...
            <div class="row">
                ...
                <div class="col-lg-2 content order-1 order-lg-1">
                    <ul class="text-end pags lisnrg">
                        <a href="/Posgrado/Acerca_de/Reglamento/Reglamento.aspx">
                            <li class="logo px-2 pb-0 bg-light" style="color: black !important; border-bottom-style: dashed; border-width: 1px;"><b>Reglamento</b></li>
                        </a>       
