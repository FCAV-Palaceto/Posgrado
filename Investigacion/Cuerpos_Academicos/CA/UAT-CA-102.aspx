<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UAT-CA-102.aspx.cs" Inherits="CuerpoAcademico" %>
    ...
    <div class="container" style="margin-bottom:-15px;">
        <div class="container" id="title">
            <div class="contenedor justify-content-center justify-content-md-between">
                <h3 class="texto-encima centrado" style="letter-spacing:1px; width:100%; font-size:30px;">Nuevas Tecnolog&iacute;as, Capital Humano y Competitividad</h3>
            </div>
        </div>
    </div>
    <br />
                    ...
                    <div class="table-responsive">                            
                        ...
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            <thead style="font-weight:bold; vertical-align:middle;">
                                <tr>
                                    <th WIDTH="100" style="background-color:#f2f2f2; text-align:left" >(UAT-CA-102)  NUEVAS TECNOLOGÍAS, CAPITAL HUMANO Y COMPETITIVIDAD  CAC</th>                     
                                </tr>
                            </thead>
                            </table>
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align:left">
                                        <p>Aguirre Ram&iacute;rez H&eacute;ctor Gabino</p>
                                        <p>Amaya Amaya Arturo</p>
                                        <p>Baca Pumarejo Jos&eacute; Rafael</p>
                                        <p>Cant&uacute; Cervantes Daniel</p>
                                        <p>Villanueva Hern&aacute;ndez Vicente</p>
                                    </td>
                                    <td style="text-align:left">
                                        <p>Castañon Rodr&iacute;guez Julio Cesar</p>
                                    </td>
                                    <td style="text-align:left">
                                        <p>1.- NUEVAS TECNOLOGÍAS PARA LA GESTIÓN DEL CONOCIMIENTO, LA COMPETITIVIDAD Y LA INNOVACIÓN.</p>
                                    </td>                                                                               
                                </tr>                                                            
                            </tbody>                                                        
                        </table>
                    ...
                    <div id="submenu" class="menu lisnrg">
                       ...
                       <ul style="text-align:initial;">
                           ...
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-CA-150.aspx">
                                <li class="border ps-2">UAT-CA-150.- Competitividad Econ&oacute;mica, Social y Ambiental de las Organizaciones</li>
                            </a>
                           ...
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-CA-102.aspx">
                                <li class="border ps-2 bg-light"><b>UAT-CA-102.- Nuevas Tecnolog&iacute;as, Capital Humano y Competitividad</b></li>
                            </a>
