<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UAT-CA-103.aspx.cs" Inherits="CuerpoAcademico" %>
    ...
    <div class="container" style="margin-bottom:-15px;">
        <div class="container" id="title">
            <div class="contenedor justify-content-center justify-content-md-between">
                <h3 class="texto-encima centrado" style="letter-spacing:1px; width:100%;">Estrategias Para el Desarrollo Regional</h3>
            </div>
        </div>
    </div>
    <br />
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            <thead style="font-weight:bold; vertical-align:middle;">
                                <tr>
                                    <th WIDTH="100" style="background-color:#f2f2f2; text-align:left" >(UAT-CA-103)  ESTRATEGIAS PARA EL DESARROLLO DEL TERRITORIO  CAC</th>                     
                                </tr>
                            </thead>
                            </table>
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align:left">
                                        <p>de la Garza Cárdenas Manuel Humberto</p>
                                        <p>Sánchez limón Mónica Lorena</p>
                                        <p>Sánchez Tovar Yesenia</p>
                                        <p>Zeron Félix Mariana</p>
                                    </td>
                                    <td style="text-align:left">
                                        <p>Hernández Hernández Nallely Guadalupe</p>
                                        <p>Mendoza Cavazos Guillermo</p>
                                    </td>
                                    <td style="text-align:left">
                                        <p>1.- EMPRENDIMIENTO Y COMPETITIVIDAD EN EL TERRITORIO</p>
                                    </td>                                                                               
                                </tr>
                            </tbody>                                    
                        </table>
                    ...
                    <div id="submenu" class="menu lisnrg">
                       ...
                       <ul style="text-align:initial;">
                           ...
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-CA-103.aspx">
                                <li class="border ps-2 bg-light"><b>UAT-CA-103.-  Estrategias Para el Desarrollo Regional</b></li>
                            </a>
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-CA-60.aspx">
