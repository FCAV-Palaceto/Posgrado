<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UAT-CA-132.aspx.cs" Inherits="CuerpoAcademico" %>
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            <thead style="font-weight:bold; vertical-align:middle;">
                                <tr>
                                    <th WIDTH="100" style="background-color:#f2f2f2; text-align:left" >(UAT-CA-132)  TECNOLOGÍAS DE INFORMACIÓN Y ESTRATEGIA  CAC</th>                     
                                </tr>
                            </thead>
                            </table>
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align:left">
                                        <p>Abrego Almazán Demian</p>
                                        <p>Medina Quintero José Melchor</p>
                                        <p>Ortiz Rodríguez Fernando Enrique</p>
                                    </td>
                                    <td style="text-align:left">
                                        <p>de la Cruz Maldonado Juan Carlos</p>
                                        <p>Haces Atondo Gerardo</p>
                                        <p>Meléndez Ruiz Enrique Ismael</p>
                                        <p>Morales Sáenz Francisco Isaí</p>
                                    </td>
                                    <td style="text-align:left">
                                        <p>1.- ADMINISTRACIÓN ESTRATÉGICA Y TECNOLOGÍAS DE INFORMACIÓN EN LAS ORGANIZACIONES</p>
                                    </td>                                                                               
                                </tr>
                            </tbody>                                    
                        </table>
                    ...
                    <div id="submenu" class="menu lisnrg">
                       ...
                       <ul style="text-align:initial;">
                           ...
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-CA-132.aspx">
                                <li class="border ps-2 bg-light"><b>UAT-CA-132.- Tecnolog&iacute;as de Informaci&oacute;n y Estrategia</b></li>
                            </a>
