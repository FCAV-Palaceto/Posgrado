<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UAT-CA-133.aspx.cs" Inherits="CuerpoAcademico" %>
    ...
    <div class="container" style="margin-bottom:-15px;">
        <div class="container" id="title">
            <div class="contenedor justify-content-center justify-content-md-between">
                <h3 class="texto-encima centrado" style="letter-spacing:1px; width:100%; font-size:30px;">Gesti&oacute;n del Comportamiento Organizacional e Individual</h3>
            </div>
        </div>
    </div>
    <br />
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            <thead style="font-weight:bold; vertical-align:middle;">
                                <tr>
                                    <th WIDTH="100" style="background-color:#f2f2f2; text-align:left" >-</th>                     
                                </tr>
                            </thead>
                            </table>
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                    ...
                    <div id="submenu" class="menu lisnrg">
                       ...
                       <ul style="text-align:initial;">
                           ...
                           <%--<a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-CA-133.aspx">
                                <li class="border ps-2 bg-light"><b>UAT-CA-133.- Gesti&oacute;n del Comportamiento Organizacional e Individual</b></li>
                           </a>--%>
