<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UAT-CA-149.aspx.cs" Inherits="CuerpoAcademico" %>
    ...
    <div class="container" style="margin-bottom:-15px;">
        <div class="container" id="title">
            <div class="contenedor justify-content-center justify-content-md-between">
                <h3 class="texto-encima centrado" style="letter-spacing:1px; width:100%; ">Estrategias de Desarrollo Regional, Urbano y Rural</h3>
            </div>
        </div>
    </div>
    <br />
                    ...
                    <div class="table-responsive">                            
                        ...
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            <thead style="font-weight:bold; vertical-align:middle;">
                                <tr>
                                    <th WIDTH="100" style="background-color:#f2f2f2; text-align:left" >(UAT-CA-149)  ESTRATEGIAS DE DESARROLLO REGIONAL URBANO Y RURAL  CAC</th>                     
                                </tr>
                            </thead>
                            </table>
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align:left">
                                        <p>Delgado Rivas Jesús Gerardo</p>
                                        <p>Galván Vera Antonio</p>
                                        <p>García Fernández Francisco</p>
                                        <p>Serna Hinojosa José Antonio</p>
                                        <p>Sevilla Morales José Ángel</p>
                                        <p>Valdez Ramírez Rolando Israel</p>
                                    </td>
                                    <td style="text-align:left">
                                        <p>Arratia Mireles Elvia</p>
                                        <p>Carrillo Sagastegui Luis Lauro</p>
                                        <p>López Gómez José Luis</p>
                                        <p>Rinconada Carbajal Fermín</p>
                                        <p>Walle Flores Grecia</p>
                                    </td>
                                    <td style="text-align:left">
                                        <p>1.- FOMENTO AL DESARROLLO ECONÓMICO REGIONAL</p>
                                    </td>                                                                               
                                </tr>                                                            
                            </tbody>                                                        
                        </table>
                    <%--  <hr />
                        ...
                        <%-- <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="https://fcav.uat.edu.mx/LER/" target="_blank">Laboratorio de Estudios Regionales LabER</a>
                                    </td>                                                                                 
                                </tr>                                                    
                            </tbody>                                                        
                        </table> --%>
                ...
                <div class="col-lg-3 content order-3 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                       ...
                       <ul style="text-align:initial;">
                           ...
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-CA-150.aspx">
                                <li class="border ps-2">UAT-CA-150.- Competitividad Econ&oacute;mica, Social y Ambiental de las Organizaciones</b></li>
                            </a>
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-CA-149.aspx">
                                <li class="border ps-2 bg-light"><b>UAT-CA-149.- Estrategias de Desarrollo Regional Urbano y Rural</b></li>
                            </a>
                    ...
                    <section class="cntnd team section-bg" style="padding: 0; margin-right:0px;">
                        <div class="member text-start">
                            ...
                            <div>
                                <ul>
                                    <a href="https://fcav.uat.edu.mx/LER/" target="_blank">
                                        <li><i class="bi bi-folder-symlink fa-lg" style="font-size: 1.5rem;"></i>&nbsp;Laboratorio de Estudios Regionales LabER</li>
                                    </a>
                                </ul>
                            </div>
                        </div>
