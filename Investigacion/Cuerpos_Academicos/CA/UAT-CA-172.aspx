<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UAT-CA-172.aspx.cs" Inherits="UAT_CA_172" %>
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            <thead style="font-weight:bold; vertical-align:middle;">
                                <tr>
                                    <th WIDTH="100" style="background-color:#f2f2f2; text-align:left" >(UAT-CA-172)  ECONOMÍA DE LA INFORMACIÓN Y DEL CONOCIMIENTO  CAEF</th>                     
                                </tr>
                            </thead>
                            </table>
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align:left">
                                        <p>Echavarría Sánchez Anabell</p>
                                        <p>González García Guadalupe Agustín</p>
                                        <p>Hernández Rodríguez Abigail</p>
                                    </td>
                                    <td style="text-align:left">

                                    </td>
                                    <td style="text-align:left">
                                        <p>1.- ECONOMÍA DE LA INFORMACIÓN Y DEL CONOCIMIENTO</p>
                                    </td>                                                                               
                                </tr>
                            </tbody>                                    
                        </table>
                    ...
                    <div id="submenu" class="menu lisnrg">
                       ...
                       <ul style="text-align:initial;">
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-CA-172.aspx">
                                <li class="border ps-2 bg-light"><b>UAT-CA-172.- Economía de la Información y del Conocimiento</b></li>
                            </a>
