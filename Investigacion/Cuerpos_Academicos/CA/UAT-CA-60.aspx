<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UAT-CA-60.aspx.cs" Inherits="CuerpoAcademico" %>
    ...
    <div class="container" style="margin-bottom:-15px;">
        <div class="container" id="title">
            <div class="contenedor justify-content-center justify-content-md-between">
                <h3 class="texto-encima centrado" style="letter-spacing:1px; width:100%;">Gesti&oacute;n P&uacute;blica y Empresarial</h3>
            </div>
        </div>
    </div>
    <br />
                    ...
                    <div class="table-responsive">                            
                        ...
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            <thead style="font-weight:bold; vertical-align:middle;">
                                <tr>
                                    <th WIDTH="100" style="background-color:#f2f2f2; text-align:left" >(UAT-CA-60)  GESTION PÚBLICA Y EMPRESARIAL  CAC</th>                     
                                </tr>
                            </thead>
                            </table>
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align:left">
                                        <p>Álvarez Herrera Maritza</p>
                                        <p>Bernal González Idolina</p>
                                        <p>Castillo Hernández Lazaro</p>
                                        <p>Flores Flores Adán jacinto</p>
                                        <p>Lavín Verastegui Jesús</p>
                                        <p>Pedraza Melo Norma Angelica</p>
                                    </td>
                                    <td style="text-align:left">
                                        <p>González Cisneros América Lorena</p>
                                    </td>
                                    <td style="text-align:left">
                                        <p>1.- FOMENTO A LA COMPETITIVIDAD DE ORGANIZACIONES DEL SECTOR PÚBLICO Y EMPRESARIAL</p>
                                    </td>                                                                               
                                </tr>                                                            
                            </tbody>                                                        
                        </table>
                ...
                <div class="col-lg-3 content order-3 order-lg-3">
                    <div id="submenu" class="menu lisnrg">
                       ...
                       <ul style="text-align:initial;">
                           ...
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-CA-60.aspx">
                                <li class="border ps-2 bg-light"><b>UAT-CA-60.- Gesti&oacute;n P&uacute;blica y Empresarial</b></li>
                            </a>
