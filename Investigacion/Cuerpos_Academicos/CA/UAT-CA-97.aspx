<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UAT-CA-97.aspx.cs" Inherits="UAT_CA_97" %>
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            <thead style="font-weight:bold; vertical-align:middle;">
                                <tr>
                                    <th WIDTH="100" style="background-color:#f2f2f2; text-align:left" >(UAT-CA-97)  DISEÑO Y DESARROLLO DE MODELOS DIGITALES PARA LA GENERACIÓN DEL CONOCIMIENTO  CAEC</th>                     
                                </tr>
                            </thead>
                            </table>
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align:left">
                                        <p>Falcone Treviño Giuseppe Francisco</p>
                                        <p>Jiménez Galán Joel Luis</p>
                                        <p>Tinajero Mallozzi Zaida Leticia</p>
                                    </td>
                                    <td style="text-align:left">

                                    </td>
                                    <td style="text-align:left">
                                        <p>1.- GENERACIÓN Y APLICACIÓN DE MODELOS DIGITALES</p>
                                    </td>                                                                               
                                </tr>
                            </tbody>                                    
                        </table>
                    ...
                    <div id="submenu" class="menu lisnrg">
                       ...
                       <ul style="text-align:initial;">
                           ...
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-CA-97.aspx">
                                <li class="border ps-2 bg-light"><b>UAT-CA-97.- Generación y Aplicación de Modelos Digitales</b></li>
                            </a>
