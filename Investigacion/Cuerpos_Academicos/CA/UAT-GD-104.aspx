<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UAT-GD-104.aspx.cs" Inherits="UAT_GD_104" %>
    ...
    <div class="container" style="margin-bottom:-15px;">
        <div class="container" id="title">
            <div class="contenedor justify-content-center justify-content-md-between">
                <h3 class="texto-encima centrado" style="letter-spacing:1px; width:100%;">Tecnolog&iacute;as de Informaci&oacute;n y Estrategia </h3>
            </div>
        </div>
    </div>
    <br />
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            <thead style="font-weight:bold; vertical-align:middle;">
                                <tr>
                                    <th WIDTH="100" style="background-color:#f2f2f2; text-align:left" >(UAT-GD-104)  POLÍTICAS PÚBLICAS POBREZA, DESARROLLO REGIONAL Y BIENESTAR SOCIAL  GD</th>                     
                                </tr>
                            </thead>
                            </table>
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align:left">
                                        <p>de la Garza Almazán Humberto</p>
                                        <p>Hernández Ilizaliturri Alma Amalia</p>
                                        <p>Jiménez Étienne Luis Eduardo</p>
                                    </td>
                                    <td style="text-align:left">

                                    </td>
                                    <td style="text-align:left">
                                        <p>1.- POLÍTICAS PÚBLICAS ORIENTADAS A LA GESTIÓN POR RESULTADOS</p>
                                        <p>2.- ANÁLISIS DEL DERECHO CONSTITUCIONAL EN LA HISTORIA JURÍDICA DE TAMAULIPAS</p>
                                    </td>                                                                               
                                </tr>
                            </tbody>                                    
                        </table>
                    ...
                    <div id="submenu" class="menu lisnrg">
                       ...
                       <ul style="text-align:initial;">
                           ...
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-GD-104.aspx">
                                <li class="border ps-2 bg-light"><b>UAT-GD-104.- Políticas Públicas Orientadas a la Gestión por Resultados - Análisis del Derecho Constitucional en la Historia Jurídica de Tamaulipas</b></li>
                           </a>
                        </ul> 
                    </div>
