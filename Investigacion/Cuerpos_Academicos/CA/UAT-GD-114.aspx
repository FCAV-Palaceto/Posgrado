<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UAT-GD-114.aspx.cs" Inherits="UAT_GD_114" %>
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            <thead style="font-weight:bold; vertical-align:middle;">
                                <tr>
                                    <th WIDTH="100" style="background-color:#f2f2f2; text-align:left" >(UAT-GD-114)  GESTIÓN E INNOVACIÓN PARA LA COMPETITIVIDAD   GD</th>                     
                                </tr>
                            </thead>
                            </table>
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align:left">
                                        <p>Castro López José Refugio</p>
                                        <p>González Bandala Daniel Alejandro</p>
                                        <p>Macias Villarreal julio cesar</p>
                                    </td>
                                    <td style="text-align:left">
                                        <p>Franco Méndez Enrique Nicolas</p>
                                    </td>
                                    <td style="text-align:left">
                                        <p>1.- GESTIÓN ESTRATÉGICA E INNOVACIÓN TECNOLÓGICA PARA EL DESARROLLO DE LA COMPETITIVIDAD</p>
                                    </td>                                                                               
                                </tr>
                            </tbody>                                    
                        </table>
                    ...
                    <div id="submenu" class="menu lisnrg">
                       ...
                       <ul style="text-align:initial;">
                           ...
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-GD-114.aspx">
                                <li class="border ps-2 bg-light"><b>UAT-GD-114.- Gestión Estratégica e Innovación Tecnológica para el Desarrollo de la Competitividad</b></li>
                           </a>
