<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UAT-GD-152.aspx.cs" Inherits="UAT_GD_152" %>
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            <thead style="font-weight:bold; vertical-align:middle;">
                                <tr>
                                    <th WIDTH="100" style="background-color:#f2f2f2; text-align:left" >(UAT-GD-152)  Organizaciones Sostenibles  GD</th>                     
                                </tr>
                            </thead>
                            </table>
                        <table class="table table-striped table-bordered" style="vertical-align:middle;">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align:left">
                                        <p>Benavides García Ramiro</p>
                                        <p>Mendoza Cavazos Yolanda</p>
                                        <p>Rubalcava de León Cristian Alejandro</p>
                                    </td>
                                    <td style="text-align:left">

                                    </td>
                                    <td style="text-align:left">
                                        <p>	1.- ESTRATEGIAS PARA EL DESARROLLO DEL TERRITORIO</p>
                                    </td>                                                                   
                                </tr>
                            </tbody>                                    
                        </table>
                    ...
                    <div id="submenu" class="menu lisnrg">
                       ...
                       <ul style="text-align:initial;">
                           ...
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/CA/UAT-GD-152.aspx">
                                <li class="border ps-2 bg-light"><b>UAT-GD-152.- Estrategias para el Desarrollo del Territorio</b></li>
                           </a>
