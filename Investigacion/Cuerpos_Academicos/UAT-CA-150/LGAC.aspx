<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LGAC.aspx.cs" Inherits="_Default" %>
                ...
                <div class="col-lg-2 content order-1 order-lg-1">
                    <ul class="text-end pags lisnrg">
                        <a href="/Posgrado/Investigacion/Cuerpos_Academicos/UAT-CA-60/Integrantes.aspx">
                            <li class="logo px-2 pb-0" style="color: black !important; border-bottom-style: dashed; border-width: 1px;">UAT-CA-60.- GESTI&Oacute;N P&Uacute;BLICA Y EMPRESARIAL - (CAC)</li>
                        </a>
                        ...
                        <a href="/Posgrado/Investigacion/Cuerpos_Academicos/UAT-CA-150/Integrantes.aspx">
                            <li class="logo px-2 pb-0 bg-light" style="color: black !important; border-bottom-style: dashed; border-width: 1px;"><b>UAT-CA-150.- COMPETITIVIDAD ECON&Oacute;MICA, SOCIAL Y AMBIENTAL DE LAS ORGANIZACIONES - (CAEC)</b></li>
                        </a>                            
                ...
                <div class="col-lg-3 content order-2 order-lg-3">
                  ...
                  <!--          <div class="collapse" id="collapseExample">
                           ...
                           <a href="/Posgrado/Investigacion/Cuerpos_Academicos/UAT-CA-150/Integrantes.aspx">
                            ...
                            <a href="/Posgrado/Investigacion/Cuerpos_Academicos/UAT-CA-150/LGAC.aspx">
                                <li class="border ps-2">LGAC</li>
                            </a>
                            <a href="/Posgrado/Investigacion/Cuerpos_Academicos/UAT-CA-150/Produccion.aspx">
