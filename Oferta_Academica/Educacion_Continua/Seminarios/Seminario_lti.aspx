<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Seminario_lti.aspx.cs" Inherits="Seminario_lti" %>
            ...
            <div  class="row">
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <div class="text-end">
                        ...
                        <hr/>
                        <h2 style="word-break: break-all;"><b>Licenciado en Tecnologías de la <br /> Información</b></h2>
                    ...
                    <table class="table  table-bordered" style="vertical-align: middle;">
                        <tbody>   
                            <tr>
                                <th width="340" style="color: #FFFFFF; background-color: #b86125; text-align: center; font-weight: bold;">Necesidades informáticas de una organización
                                </th>
                            ...
                            <tr>
                                <th width="340" style="text-align: center;">
                                    <p>Necesidades informáticas de una organización y Planeación de negocios.</p>
                                </th>
                                <td>Dr. Héctor Gabino Aguirre Ramírez</td>
                                <td width="30" style="text-align: center;">10</td>
                                <td width="60" style="text-align: center;">10 y 11 Febrero</td>
                            </tr>
                            <tr>
                                <th width="340" style="text-align: center;">
                                    <p>Necesidades de información e infraestructura y Propuesta de solución.</p>
                                </th>
                                <td>Dr. Demian Abrego Almazán</td>
                                <td width="30" style="text-align: center;">10</td>
                                <td width="60" style="text-align: center;">17 y 18 Febrero</td>
                            </tr>
                        </tbody>
                    </table>
                    <%-- 2 --%>
                    <table class="table  table-bordered" style="vertical-align: middle;">
                        <tbody>   
                            <tr>
                                <th width="340" style="color: #FFFFFF; background-color: #b86125; text-align: center; font-weight: bold;">Gestión de proyectos informáticos
                                </th>
                                <th width="30" style="color: #FFFFFF; background-color: #b86125; text-align: center; font-weight: bold;">Catedrático</th>
                                <th width="30" style="color: #FFFFFF; background-color: #b86125; text-align: center; font-weight: bold;">Número de horas</th>
                                <th width="60" style="color: #FFFFFF; background-color: #b86125; text-align: center; font-weight: bold;">Fechas</th>
                            ...
                            <tr>
                                <th width="340" style="text-align: center;">
                                    <p>Gestión de proyectos informáticos y Planeación y viabilidad de proyectos informáticos.</p>
                                </th>
                                <td>Dr. Gerardo Haces Atondo</td>
                                <td width="30" style="text-align: center;">10</td>
                                <td width="60" style="text-align: center;">24 y 25 Febrero</td>
                            </tr>
                            <tr>
                                <th width="340" style="text-align: center;">
                                    <p>Ejecución del proyecto informático y Control y cierre del proyecto informático.</p>
                                </th>
                                <td>Mtro. Enrique Nicolás Franco Méndez</td>
                                <td width="30" style="text-align: center;">10</td>
                            ...
                            <tr>
                                ...
                                <td>Mtro. Lázaro Guillermo Avendaño Cisneros</td>
                                <td width="30" style="text-align: center;">10</td>
                                <td width="60" style="text-align: center;">10 y 11 de Marzo</td>
                            </tr>
                        </tbody>
                    </table>
                    <%-- 3 --%>
                    <table class="table  table-bordered" style="vertical-align: middle;">
                        <tbody>   
                            ...
                            <tr>
                                <th width="340" style="text-align: center;">
                                    <p>Implementación de Sistemas de Información y Características de sistemas de información.</p>
                                </th>
                                <td>Dr. José Refugio Castro López</td>
                                <td width="30" style="text-align: center;">10</td>
                                <td width="60" style="text-align: center;">24 y 25 de Marzo</td>
                            </tr>
                            <tr>
                                <th width="340" style="text-align: center;">
                                    <p>Conceptos de programación y Bases de datos.</p>
                                </th>
                                <td>Mtro. Juan Fco. De la Cruz Reyna</td>
                                <td width="30" style="text-align: center;">10</td>
                                <td width="60" style="text-align: center;">21 y 22 de Abril</td>
                            </tr>
                            <tr>
                                <th width="340" style="text-align: center;">
                                    <p>Implementación de aplicaciones informáticas.</p>
                                </th>
                                <td>Mtro. Santos Abelardo Linares Maldonado</td>
                                <td width="30" style="text-align: center;">10</td>
                                <td width="60" style="text-align: center;">19 y 20 de Mayo</td>
                            </tr>
                        </tbody>
                    </table>
                    <%-- 4 --%>
                    <table class="table  table-bordered" style="vertical-align: middle;">
                        <tbody>   
                            ...
                            <tr>
                                <th width="340" style="text-align: center;">
                                    <p>- Función informática y Gestión de la función informática.</p>
                                    <p>- Evaluación informática.</p>
                                </th>
                            ...
                            <tr>
                                <th width="340" style="text-align: center;">
                                    <p>Auditoría informática y Seguridad informática.</p>
                                </th>
                                <td>Mtro. José Iván Lara Treviño</td>
                                <td width="30" style="text-align: center;">20</td>
                    ...
                    <div id="submenu" class="menu lisnrg">
                        ...
                        <ul>
                            ...
                            <a style="word-break: break-all;" href="/Posgrado/Oferta_Academica/Educacion_Continua/Seminarios/Seminario_lti.aspx">
                                <li class="border ps-2 bg-light"><b>Seminario de Licenciado en <br /> Tecnologías de la Información</b></li>
                            </a>
