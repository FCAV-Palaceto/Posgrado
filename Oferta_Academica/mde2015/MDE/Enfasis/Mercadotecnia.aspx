<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Mercadotecnia.aspx.cs" Inherits="_Default" %>
        ...
        <section id="about" class="about" style="margin-top: -10px;">
            <div class="row">
                ...
                <div class="col-lg-7 content order-3 order-lg-2">                    
                    ...
                    <hr>
                    <div class="content imgs" style="background-image: url(imgs/2.png);"></div>
                    <div class="mt-3">
                        <p>
                            ...
                            <div class="collapse" id="collapseExample">
                                <ul>
                                    ...
                                    <a href="/Posgrado/Oferta_Academica/mde2015/MDE/Enfasis/Mercadotecnia.aspx">
                                        <li class="border ps-4 bg-light"><b>Mercadotecnia</b></li>
                                    </a>
