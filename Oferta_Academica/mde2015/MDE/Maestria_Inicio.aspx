<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Maestria_Inicio.aspx.cs" Inherits="_Default" %>
        ...
        <section id="about" class="about" style="margin-top: -10px;">
            <div class="row">
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    <!-- <div class="content imgs" style="background-image: url(imgs/dca.jpg);"></div> -->
                    <div class="text-end">
                    ...
                    <div style="text-align: center;">
                        <img src="imgs/DiagramaMDE.PNG" class="img-fluid w-75" alt="Diagrama DCA">
                    </div>
                    <div>
                        <p>El programa de Maestría en Dirección Empresarial tiene por objetivo desarrollar competencias profesionales distintivas en la administración eficaz de las áreas funcionales clave de las organizaciones en cuanto a Administración Estratégica, Finanzas, Sistemas y Negocios de Electrónicos, Recursos Humanos y Mercadotecnia.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 content order-3 order-lg-3">
                    ...
                    <section class="cntnd team section-bg" style="padding: 0; margin-right:0px;">
                        <div class="member text-start">
                            ...
                            <div>
                                <a href="files/SistemaAseguramientoRenov.PNPC2020.pdf" target="_blank"><i class="bi bi-file-earmark-pdf-fill fa-lg me-2" style="font-size: 1.5rem;"></i>Sistema Aseguramiento Renov. PNPC 2020</a>            
                            </div>
                        </div>
                    </section>
