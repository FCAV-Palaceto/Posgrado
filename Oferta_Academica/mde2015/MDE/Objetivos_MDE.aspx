<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Objetivos_MDE.aspx.cs" Inherits="_Default" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <div class="mt-3">                        
                        ...
                        <p>Formar Maestros en Dirección Empresarial con los más altos estándares de calidad, para ejercer la dirección de empresas desde la excelencia profesional</p>
                        
                        <h4><b>Metas</b></h4>

                        <p>Transmitir conocimientos de gestión empresarial, así como de especialización, en las áreas funcionales de las organizaciones.</p>
                        <p>Desarrollar en el futuro máster, capacidades y habilidades directivas, para que tenga las herramientas pertinentes para la elaboración de alternativas estratégicas, así como para el proceso toma de decisiones.</p>
                        <p>Fomentar acciones de vinculación, para el reconocimiento de la aplicación y transferencia del conocimiento en ecosistemas reales, e identificar su impacto en el desarrollo de las organizaciones dentro de los entornos en los que interactúan.</p>
                        <p>Crear en el futuro master, una conciencia de responsabilidad social, para que en sus acciones dentro de las organizaciones, consideren la resolución de problemáticas sociales en la región en donde coexisten las organizaciones que dirigen.</p>
                    </div>                                         
                </div>
                    ...
                    <div id="submenu" class="menu lisnrg">
                        ...
                        <ul>
                            ...
                            <a href="/Posgrado/Oferta_Academica/mde2015/MDE/Objetivos_MDE.aspx">
                                <li class="border ps-2 bg-light"><b>Objetivo</b></li>
                            </a>
