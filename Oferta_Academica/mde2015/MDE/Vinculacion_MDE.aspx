<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Vinculacion_MDE.aspx.cs" Inherits="_Default" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <div class="mt-3">
                        ...
                        <p>
                           En la División de Estudios de Posgrado e Investigación (DEPI) se tiene definida una estrategia de Vinculación, con la finalidad de promover e impulsar acciones que permitan incidir con un mayor impacto en la formación integral de los estudiantes del programa de MDE, asimismo que contribuya a la retroalimentación de las funciones sustantivas de formación profesional del alumno. De tal modo, que el PE de MDE desarrolla ciertos mecanismos de vinculación que apoyan al fortalecimiento de las habilidades y capacidades gerenciales del alumno, que a su vez favorecen la interrelación con los sectores productivos y sociales.
                        </p>    
                        <p>
                            La colaboración con los sectores de la sociedad, con principal incidencia (Empresarial), se da a través de dos mecanismos, los cuales son la Intervención Empresarial y la Estancia Empresarial.
                        </p>
                        <div class="text-center container">
                            <p>
                                <b>Actividades de vinculación</b>
                            </p>
                            <!-- Imagen calendarización, img-fluid para hacerla responsive -->
                            <img class="img-fluid" src="imgs/calendario.jpg" alt="Calendario"/>
                            <!-- i para que sea cursiva -->
                            <p style="font-size: smaller;"><i>Fuente. Elaboración propia.</i></p>
                        </div>
                        <p class="mt-4">
                            La tabla siguiente presenta algunos de los principales proyectos que han sido realizados por el alumnado de la Maestría en Dirección Empresarial. 
                        </p>
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" style="vertical-align:middle;">
                                <thead style="vertical-align:middle; font-weight: bold; text-align: center;">
                                    <tr>
                                        <td width="250">Institución/Programa</td>
                                        <td>Objetivo</td>
                                        <td width="190">Acciones</td>
                                        <td>Status</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Realizar asesorías para el desarrollo de planes estratégicos a empresas miembros del programa Hecho en Tam.</td>
                                        <td>Participación de alumnos y catedráticos para la elaboración de planes estratégicos. </td>
                                        <td style="text-align:center">Vigente</td>
                                    </tr>
                                    <tr>
                                        <td>Aeropuertos y Servicios Auxiliares Ciudad Victoria</td>
                                        <td>Promover la experiencia profesional de alumnos de la MDE.</td>
                                        <td>Participación de alumnos en la MDE para la gestión de estancias empresariales.</td>
                                        <td style="text-align:center">Concluido</td>
                                    </tr>
                                    <tr>
                                        <td>Confederación Patronal de la República Mexicana (COPARMEX)</td>
                                        <td>Profundizar el conocimiento al sector comercial sobre temas relacionados con la administración y sus derivados.</td>
                                        <td>Cooperación para la elaboración y exposición de conferencias y contenido para la sociedad civil.</td>
                                        <td style="text-align:center">Vigente</td>
                                    </tr>
                                    <tr>
                                        <td>Gobierno Municipal de Ciudad Victoria, Tamaulipas. Secretaría de Economía. </td>
                                        <td>Promover el dialogo y conocimiento empresarial con los sectores vulnerables.</td>
                                        <td>Divulgar conocimiento a sectores de la sociedad civil por parte del alumnado y docentes.</td>
                                        <td style="text-align:center">Vigente</td>
                                    </tr>
                                    <tr>
                                        <td>Instituto Mexicano de Ejecutivos de Finanzas (IMEF). </td>
                                        <td>Promover el dialogo y conocimiento empresarial con los sectores vulnerables.</td>
                                        <td>Participación de alumnos para la impartición de conferencias.</td>
                                        <td style="text-align:center">Vigente</td>
                                    </tr>
                                    <tr>
                                        <td>Cámara Nacional de la Industria de Restaurantes y Alimentos Condimentados (CANIRAC).</td>
                                        <td>Profundizar el conocimiento al sector comercial sobre temas relacionados con la administración y sus derivados.</td>
                                        <td>Cooperación para la elaboración y exposición de conferencias y contenido para la sociedad civil.</td>
                                        <td style="text-align:center">Vigente</td>
                                    </tr>
                                    <tr>
                                        <td>Cámara Nacional de Comercio (CANACO) Servytur, Ciudad Victoria.</td>
                                        <td>Profundizar el conocimiento al sector comercial sobre temas relacionados con la administración y sus derivados.</td>
                                        <td>Cooperación para la elaboración y exposición de conferencias y contenido para la sociedad civil.</td>
                                        <td style="text-align:center">Vigente</td>
                                    </tr>
                                    <tr>
                                        <td>Gobierno Municipal de Hidalgo, Tamaulipas.</td>
                                        <td>Apoyar en la generación del plan estratégico para el desarrollo de la región de Santa Engracia.</td>
                                        <td>Desarrollo y ejecución de planes estratégicos en la región de Santa Engracia.</td>
                                        <td style="text-align:center">Vigente</td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <img class="img-fluid" src="../../../assets/img/imagen%20vinculacion.png" width="800" height="800"/>
