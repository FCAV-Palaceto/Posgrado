<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Convocatoria_DCA.aspx.cs" Inherits="_Default" %>
          ...
          <section id="about" class="about" style="margin-top: -10px;">
              <div class="row">
                  ...
                  <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <hr>  
                    <img class="img-fluid" src="imgs/dca2022.PNG" alt="Convocatoria"/>
                    <div class="mt-3">
                 ...
                 <section class="cntnd team section-bg" style="padding: 0; margin-right:0px;">
                        ...
                        <div>
                            <a href="files/DCA-2022-CONVOCATORIA.pdf" target="_blank"><i class="bi bi-file-earmark-pdf-fill fa-lg me-2" style="font-size: 1.5rem;"></i>Convocatoria 2023</a>  
                        </div>
                      </div>
                  </section>
