<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Costo.aspx.cs" Inherits="Costo" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <table class="table table-striped table-bordered" style="vertical-align:middle;">
                        ...
                        <tbody>
                            <tr>
                                <td>Inscripción o Reinscripción por periodo lectivo</td>
                                <td>$23,027.00</td>
                            </tr>
                        </tbody>
                        </table>
                    ...
                    <div id="submenu" class="menu lisnrg">
                        ...
                        <ul>
                            ...
                            <a href="/Posgrado/Oferta_Academica/secciones2015/DCA/Costo.aspx">
                                <li class="border ps-2 bg-light"><b>Costo</b></li>
                            </a>
                        </ul>
                    </div>
