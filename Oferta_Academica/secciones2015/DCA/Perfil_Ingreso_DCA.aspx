<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Perfil_Ingreso_DCA.aspx.cs" Inherits="_Default" %>
        ...
        <section id="about" class="about" style="margin-top: -10px;">
                ...
                <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom: 40px;">
                    ...
                    <div class="mt-3">
                      <h4><b>Perfil de Ingreso</b></h4>
                        <p>
                           El Doctorado en Ciencias Administrativas puede aceptar a los candidatos provenientes de cualquier institución de educación superior, nacional o extranjera con estudios previos de maestría en algún campo de las Ciencias Sociales.
                        </p>
            ...
            <section class="cntnd team section-bg" style="padding: 0; margin-right:0px;">
                        <div class="member text-start">
                          ...
                          <div>
                                <ul>
                                    <a href="files/PerfildeIngresoExtenso.pdf">
                                        <li><i class="bi bi-file-earmark-pdf-fill fa-lg" style="font-size: 1.5rem;"></i>Perfil de Ingreso Extenso</li>
                                    </a>
                                </ul>
                            </div>
                      </div>
