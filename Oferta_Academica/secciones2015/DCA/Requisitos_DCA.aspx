<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Requisitos_DCA.aspx.cs" Inherits="_Default" %>
          ...
          <section id="about" class="about" style="margin-top: -10px;">
              <div class="row">
                  ...
                  <div class="col-lg-7 content order-2 order-lg-2" style="margin-bottom:40px;">
                    ...
                    <hr>
                      <div class="mt-3">
                        <h4><b>Requisitos de Admisi&oacute;n</b></h4>
                            <ol start="1">
                            <li>Integrar un expediente en los términos y fechas que la Convocatoria vigente indique.</li>
                            <li>Acreditar el EXANI III de CENEVAL con al menos 1000 puntos.</li>
                            <li>Presentar Certificado TOEFL ITP vigente con una puntuación mínima de 500 puntos.</li>
                            <li>Asistir a la entrevista con el Consejo evaluador encargado de la selección, previamente aprobado por el Comité Académico de la División de Estudios de Posgrado e Investigación de la FCAV.</li>
                            <li>Al acreditar las etapas anteriores, deberán preparar su anteproyecto de investigación mediante un curso propedéutico impartido por la División de Estudios de Posgrado e Investigación de la FCAV.</li>
                            <li>Presentar el anteproyecto ante Consejo Evaluador, el cual ha de ser original, pertinente y que refleje una contribución relevante a la ciencia administrativa en las sub-líneas de investigación adscritas al programa en un máximo de veinte cuartillas.</li>
                            <li>Cumplir con las colegiaturas y cuotas de inscripción o en su caso establecer un compromiso de pago.</li>
                            </ol>
                          <p>Para más información sobre el proceso de admisión, requisitos y papelería solicitada, puedes descargar el documento en extenso en la sección “Documentos relacionados”</p>
                  ...
                  <div class="col-lg-3 content order-3 order-lg-3">
                      <div id="submenu" class="menu lisnrg">
                          ...
                          <ul>
                            ...
                            <a href="/Posgrado/Oferta_Academica/secciones2015/DCA/Requisitos_DCA.aspx">
                                <li class="border ps-2 bg-light"><b>Requisitos de Admisi&oacute;n</b></li>
                            </a>
                   ...
                   <section class="cntnd team section-bg" style="padding: 0; margin-right:0px;">
                        <div class="member text-start">
                          ...
                          <div>
                                <ul>
                                    <a href="files/RequisitodeAdmisiónExtenso.pdf">
                                    <li><i class="bi bi-file-earmark-pdf-fill fa-lg" style="font-size: 1.5rem;"></i>Requsitos de Adminsión Extenso</li>
                                        </a>
                                </ul>
                            </div>
                      </div>
